...
{
    public partial class GameTablesadded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlayerGamesId = table.Column<int>(type: "int", nullable: false),
                    PlayersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GamePlayer", x => new { x.PlayerGamesId, x.PlayersId });
                    table.ForeignKey(
                        name: "FK_GamePlayer_Games_PlayerGamesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswerStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
